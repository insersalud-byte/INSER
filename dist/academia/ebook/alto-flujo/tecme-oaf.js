(function () {
  ...
  root.innerHTML = `
    <div class="tec-intro"><div><p class="tec-eyebrow">VISTA PREVIA LOCAL · SIMULADOR EDUCATIVO</p><h2>Neumovent Advance · Alto flujo</h2><p>Tocá un ajuste, girá la perilla y pulsala para confirmar.</p></div><a class="tec-source-link" href="#tec-fuentes">Referencias y alcance ↓</a></div>
    <p class="tec-note">Frente recreado según la referencia del Advance. Distribución OAF contrastada con una fotografía real y secuencia basada en el manual TECME. No es firmware ni equipo clínico.</p>
    <div class="tec-workspace">
      <div class="tec-device-wrap" id="tec-equipo"><div class="tec-machine">
        <div class="tec-shell-top"><strong>tecme</strong><span id="tec-top-lamp" aria-label="Indicador luminoso de alarma"></span></div>
        ...
        </div><div class="tec-name"><span>neumovent <b>advance</b></span><small>SIMULADOR</small></div>
