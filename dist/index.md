...
description: "Terapias respiratorias domiciliarias en Córdoba y venta de CPAP, BiPAP y concentradores de oxígeno con envío a todo el país. Alquiler con instalación en Córdoba. Cuotas con Banco Galicia. Aparatología ANMAT. ☎ +54 9 351 206-5320."
url: https://insersalud.com/
canonical: https://insersalud.com/
...
## No te entregamos una caja

Tu equipo llega configurado según la indicación de tu médico (presión, flujo, modo), listo para usar desde la primera noche. No tenés que aprender a programarlo ni adivinar valores.
...
Y si dudás entre alquilar y comprar: alquilá un CPAP o AutoCPAP, probalo en tu casa, y si después lo comprás te descontamos ese primer mes del precio de venta.

## Quiénes estamos detrás de INSER SALUD
...
Por eso cuando decimos que el equipo se entrega configurado según la indicación de tu médico, hay alguien que sabe leer esa indicación.

### ¿Qué es un CPAP?

Un CPAP entrega una presión de aire fija y continua que mantiene abiertas las vías respiratorias durante el sueño. Es el tratamiento estándar de la apnea obstructiva del sueño.

### ¿Qué es un AutoCPAP?

El AutoCPAP (APAP) funciona como un CPAP pero ajusta la presión automáticamente noche a noche según la respiración del paciente, ofreciendo mayor comodidad.

### ¿Qué es un BiPAP?

Un BiPAP entrega dos presiones: una mayor al inhalar (IPAP) y otra menor al exhalar (EPAP). Se usa en EPOC, enfermedades neuromusculares e hipoventilación, y puede tener frecuencia respiratoria de respaldo.

### ¿Qué es la oxigenoterapia?

Es el aporte de oxígeno suplementario mediante concentradores de oxígeno (estacionarios para el hogar o portátiles para salir) o tubos, indicado cuando la saturación de oxígeno en sangre es baja.

### ¿Qué es un concentrador de oxígeno?

Un equipo que filtra el aire del ambiente y entrega oxígeno concentrado (≥93%). Estacionario para uso continuo en el hogar, o portátil con batería para viajar.

### ¿Máscara nasal o nasobucal?

La máscara nasal cubre solo la nariz (cómoda y liviana, para quienes respiran por la nariz). La nasobucal o full face cubre nariz y boca, ideal para quienes respiran por la boca o necesitan presiones altas (DreamWear, ResMed AirFit F20/F30, BMC F6).

## CPAP vs AutoCPAP vs BiPAP

| Equipo | Cómo funciona | Para qué | Desde |
| --- | --- | --- | --- |
...
La máscara es donde más pacientes abandonan el tratamiento, y casi siempre es por una máscara mal elegida, no por el equipo. Estos son los 5 tipos que vendemos, para quién es cada uno y a qué precio.

### Máscara Nasal

Cubre solo la nariz, con un arnés liviano. Es la más usada y la que mejor tolera la mayoría de los pacientes.

**Para quién:** Para quienes respiran por la nariz durante el sueño: menos volumen sobre la cara, menos sensación de encierro y más libertad para moverse en la cama.

**A tener en cuenta:** Si dormís con la boca abierta se escapa el aire y perdés presión. En ese caso conviene una nasobucal o sumar una mentonera.
...
- Mascarilla Nasal DreamWear Philips — U$S 153

### Máscara Nasobucal (full face)

Cubre nariz y boca a la vez, con un sellado más amplio sobre la cara.

**Para quién:** Para quienes abren la boca al dormir, tienen la nariz congestionada seguido o necesitan presiones altas. También es la habitual en BiPAP.

**A tener en cuenta:** Pesa y apoya más que la nasal, así que el talle correcto es clave: una nasobucal grande de más pierde aire y marca la cara.

- Máscara Nasobucal BMC F6 multitalle — U$S 124
- Mascarilla Nasobucal DreamWear Philips — U$S 157
- Buconasal BMC F5A sin apoya frente — U$S 52
- Buconasal Yuwell con apoya frente — U$S 52
- Nasobucal AirFit F30 ResMed — U$S 212

### Máscara Almohadillas nasales

No cubren la nariz: apoyan directamente en las fosas nasales con dos almohadillas de silicona.

**Para quién:** Para quienes se sienten encerrados con las otras máscaras, usan anteojos para leer en la cama, tienen barba o duermen boca abajo.

**A tener en cuenta:** Al ser el contacto más chico, en presiones altas puede molestar el chorro de aire directo en la nariz.
...
**Para quién:** Lactantes y niños con indicación de ventilación, habitualmente en atrofia muscular espinal, parálisis cerebral y cuadros neuromusculares.

**A tener en cuenta:** La Philips Wisp pediátrica es la que más eligen los padres, y se reconoce por su funda con estampado de jirafa: en un nene, que acepte la máscara es la mitad del tratamiento, y una máscara que no le da miedo se tolera mucho mejor noche tras noche. Tiene armazón compacto y almohadilla de silicona hipoalergénica que apoya solo sobre la nariz, compatible con CPAP y BiPAP. La línea pediátrica es difícil de conseguir en el país; tenemos tres opciones y talles desde neonatal, y el talle no se elige por catálogo: se asesora según la edad, la anatomía del paciente y la indicación médica.

- Máscara Nasal Pediátrica HSINER Cirri Mini — U$S 105
- Máscara Nasal Pediátrica Philips Wisp (jirafa)
- Infant CPAP Kit neonatal (talles 00 a 5) — U$S 97

### Máscara Sin fuga (terapia intensiva)

Máscara NO ventilada: no tiene los orificios de fuga que sí traen las de uso domiciliario.

**Para quién:** Para respiradores de terapia intensiva y ventilación no invasiva con circuito de doble rama o válvula espiratoria.

**A tener en cuenta:** NO sirve para un CPAP o BiPAP domiciliario común: sin la fuga controlada se reinhala el aire exhalado. Es un producto de uso profesional.

- Máscara Buconasal BMC F2 codo azul — $68.000

El talle importa tanto como el tipo: una máscara del talle equivocado pierde aire y te despierta. Ver todas en [máscaras para CPAP y BiPAP](https://insersalud.com/mascaras-cpap).
...
- Venta de equipos respiratorios aprobados por ANMAT, con envío a todo el país

- Alquiler de CPAP, BiPAP y concentradores de oxígeno (en Córdoba)

- Oxigenoterapia domiciliaria con instalación y seguimiento

- Adaptación y seguimiento de equipos con profesionales

- Servicio técnico de equipos respiratorios
...
- [Alquiler de equipos respiratorios en Córdoba](https://insersalud.com/alquiler-equipos-respiratorios-cordoba)

- [Comprar CPAP en Córdoba](https://insersalud.com/comprar-cpap-cordoba)

- [Alquiler de CPAP en Córdoba](https://insersalud.com/alquiler-cpap-cordoba)

- [BiPAP en Córdoba](https://insersalud.com/bipap-cordoba)

- [Oxígeno a domicilio en Córdoba](https://insersalud.com/oxigeno-a-domicilio-cordoba)

- [Alquiler de concentrador de oxígeno en Córdoba](https://insersalud.com/alquiler-concentrador-oxigeno-cordoba)

- [Concentrador de oxígeno portátil en Córdoba](https://insersalud.com/concentrador-oxigeno-portatil-cordoba)

- [Estudio del sueño a domicilio en Córdoba](https://insersalud.com/estudio-del-sueno-cordoba)

- [Comprar CPAP en Argentina (envío a todo el país)](https://insersalud.com/comprar-cpap-argentina)

- [Comprar concentrador de oxígeno en Argentina (envío)](https://insersalud.com/comprar-concentrador-oxigeno-argentina)

- [Concentrador de oxígeno de 10 litros (alto flujo)](https://insersalud.com/concentrador-oxigeno-10-litros)

- [Máscaras para CPAP y BiPAP (nasales, nasobucales y pediátricas)](https://insersalud.com/mascaras-cpap)

- [Máscaras pediátricas para CPAP y BiPAP (Philips Wisp, Cirri Mini, Infant Kit)](https://insersalud.com/mascaras-pediatricas)

- [Equipamiento para centros de rehabilitación pulmonar](https://insersalud.com/equipamiento-rehabilitacion-pulmonar)

- [Comprar concentrador de oxígeno portátil (envío a todo el país)](https://insersalud.com/comprar-concentrador-oxigeno-portatil-argentina)

- [Ventilador ResMed STELLAR 150](https://insersalud.com/ventilador-stellar-150)

- [Comprar polígrafo respiratorio (estudios del sueño)](https://insersalud.com/comprar-poligrafo-argentina)

- [Cough Assist — asistente de tos mecánico](https://insersalud.com/cough-assist-asistente-de-tos)

[Política de privacidad](https://insersalud.com/politica-de-privacidad) · [Política de devoluciones](https://insersalud.com/politica-de-devoluciones) · [Botón de arrepentimiento](https://insersalud.com/politica-de-devoluciones#arrepentimiento) · [Tarjeta digital de contacto](https://insersalud.com/tarjeta) · [Academia: formación gratuita para profesionales (9 cursos gratuitos de terapia respiratoria, ebooks interactivos)](https://insersalud.com/academia)

## Cómo trabajamos

1. **Nos contactás**: por WhatsApp, teléfono, formulario o con Santi. Respondemos consultas por WhatsApp todos los días, también fines de semana y fuera del horario comercial.

2. **Te asesoramos**: elegimos el equipo correcto según tu prescripción médica y tu presupuesto.

3. **Entregamos e instalamos**: en Córdoba a domicilio en el día; al resto del país, envío con puesta en marcha guiada.

4. **Te acompañamos**: adaptación, soporte técnico, repuestos y factura con presupuesto formal para el reintegro de tu obra social.

## Patologías que tratamos

- [Apnea del sueño](https://insersalud.com/patologia/apnea-del-sueno)

- [EPOC](https://insersalud.com/patologia/epoc)

- [Fibrosis pulmonar](https://insersalud.com/patologia/fibrosis-pulmonar)

- [ELA (Esclerosis Lateral Amiotrófica)](https://insersalud.com/patologia/esclerosis-lateral-amiotrofica)

- [Atrofia Muscular Espinal](https://insersalud.com/patologia/atrofia-muscular-espinal)

- [Parálisis cerebral](https://insersalud.com/patologia/paralisis-cerebral)

## Sobre INSER SALUD

Empresa cordobesa con más de 5 años de experiencia y más de 500 pacientes atendidos. Aparatología aprobada por ANMAT. La venta de equipos se realiza con envío a todo el país (cualquier provincia de Argentina); el alquiler está disponible en Córdoba, con entrega en el día y soporte técnico continuo. Atención por WhatsApp +54 9 351 206-5320 y asesoramiento con el agente Santi.

Contacto: [WhatsApp +54 9 351 206-5320](https://wa.me/5493512065320) · [Llamar](tel:+5493512065320) · inser.salud@gmail.com · Córdoba, Argentina

---

Índice del sitio para agentes: https://insersalud.com/llms.txt · Contenido completo: https://insersalud.com/llms-full.txt
