---
title: "EPOC · Tratamiento Domiciliario | INSER SALUD"
description: "Brindamos información, equipos certificados y asesoramiento personalizado para que los pacientes con EPOC recuperen su calidad de vida."
url: https://insersalud.com/patologia/epoc
canonical: https://insersalud.com/patologia/epoc
...
# EPOC — Tratamiento Domiciliario

**Vivir con EPOC: equipamiento y acompañamiento para respirar mejor**

Brindamos información, equipos certificados y asesoramiento personalizado para que los pacientes con EPOC recuperen su calidad de vida.

La EPOC es una enfermedad pulmonar crónica que dificulta la respiración. Con el tratamiento adecuado y el equipamiento correcto se puede llevar una vida activa y con buena calidad. En Inser Salud te acompañamos con aparatología aprobada por ANMAT y asesoramiento profesional.

La Enfermedad Pulmonar Obstructiva Crónica (EPOC) es una condición que dificulta el paso de aire hacia y desde los pulmones. Provoca tos persistente con producción de moco, sibilancias y falta de aire al esfuerzo. Aunque no tiene cura, el tratamiento correcto — incluyendo oxigenoterapia, inhaladores, broncodilatadores y rehabilitación pulmonar — puede mejorar significativamente la calidad de vida y frenar la progresión.

## ¿Qué es la EPOC y cómo afecta la respiración?

La Enfermedad Pulmonar Obstructiva Crónica (EPOC) engloba principalmente dos condiciones: el enfisema pulmonar y la bronquitis crónica. En ambos casos, el flujo de aire queda obstruido de manera permanente, dificultando la respiración.
...
## Técnica Inhalatoria Correcta con Aerocámara

El inhalador es la base del tratamiento farmacológico de la EPOC. Sin embargo, estudios demuestran que más del 70% de los pacientes no utiliza correctamente su inhalador, lo que reduce drásticamente la efectividad del medicamento.
...
La oxigenoterapia domiciliaria está indicada en pacientes con EPOC que presentan insuficiencia respiratoria crónica: saturación de oxígeno (SpO₂) por debajo del 88% en reposo o al ejercicio.
...
## Exacerbaciones: Cómo Prevenir Internaciones

Las exacerbaciones de EPOC (crisis de empeoramiento agudo) son la principal causa de internación y mortalidad en estos pacientes. La mayoría son causadas por infecciones virales o bacterianas, contaminación o mal control del tratamiento.
...
La rehabilitación pulmonar es el tratamiento no farmacológico más efectivo para la EPOC. Consiste en un programa supervisado de ejercicio físico, educación sobre la enfermedad y apoyo psicosocial.
...
- ![Concentrador Portátil KINGON P2-S3](https://insersalud.com/artifacts/products/f18cede5-9404-4eee-a751-01f532e715d7.jpg) Concentrador Portátil KINGON P2-S3 — U$S 1.880

- ![Concentrador Portátil KINGON P2-TOC](https://insersalud.com/artifacts/products/dbf2f4a8-6dd6-4d06-863f-2a14deaa9086.jpg) Concentrador Portátil KINGON P2-TOC — U$S 3.458

- ![GCE Zen-O (2 baterías + carro)](https://insersalud.com/artifacts/products/47b7a3ad-17b0-41c1-a9a9-0b26530f595e.jpg) GCE Zen-O (2 baterías + carro) — U$S 3.747

- ![Concentrador de Oxígeno YUWELL Estacionario](https://insersalud.com/artifacts/products/b9875919-47d8-482e-ba62-800aff89739d.jpeg) Concentrador de Oxígeno YUWELL Estacionario — U$S 713

- ![Mochila de Oxígeno Portátil](https://insersalud.com/artifacts/products/c1aa3c71-a9fb-422a-82ac-222625d0bd3a.jpg) Mochila de Oxígeno Portátil — U$S 270

## Preguntas frecuentes sobre EPOC

### ¿Qué equipos se usan en el tratamiento domiciliario de la EPOC?

Los más frecuentes son los concentradores de oxígeno para oxigenoterapia domiciliaria y, en casos de mayor compromiso, los equipos de ventilación no invasiva tipo BiPAP. Qué corresponde en cada caso, y con qué flujo o presión, lo indica el neumonólogo.

### ¿Cuántas horas por día se usa el oxígeno?

Lo define tu médico según los resultados de saturación y gases en sangre. Nuestros concentradores están preparados para uso continuo las 24 horas del día, así que soportan cualquier esquema que te hayan indicado.

### ¿Se puede alquilar el concentrador de oxígeno?

En Córdoba sí, con entrega e instalación a domicilio y capacitación en el uso. Es la opción habitual después de una internación o para tratamientos por tiempo definido. A todo el país vendemos con envío.

### ¿Sirve un concentrador portátil para salir de casa?
...
Esta información es orientativa y no reemplaza la consulta médica. El equipo y los parámetros de uso los indica tu médico tratante.

INSER SALUD — equipos y asesoramiento para EPOC en Córdoba. [WhatsApp +54 9 351 206-5320](https://wa.me/5493512065320) · [Llamar](tel:+5493512065320).
